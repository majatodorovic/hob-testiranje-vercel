...
const BillingAddresses = () => {
  ...
  return (
    <div>
      <div className="mb-[2rem] flex min-h-[7rem] items-center justify-between rounded-lg bg-[#f8f8f8] p-[1.4rem] max-md:flex-col max-md:gap-4 sm:w-[90%]">
        <h1 className="pb-0 text-3xl">Adrese plaćanja</h1>
        <Link
