  ...
  const memoizedItems = useMemo(() => {
    return productData?.items?.map(({ id }) => {
      return (
        ...
        >
          <ThumbSuspense categoryId={path} id={id} />
        </Suspense>
      );
    });
  }, [productData, path]);
    ...
    <div>
      <div className="mt-[30px] md:mt-[80px]">
        <div className="grid grid-cols-2">
          <div className="relative col-span-1 flex flex-col items-center justify-center pl-[8%] max-md:col-span-2">
            <Image
              src={leaf}
              width={600}
              height={800}
              className="absolute -top-[3rem] left-0 z-[1] opacity-[0.8]"
            />
            <div>
              <div className="relative z-[4] flex w-fit flex-wrap items-center gap-2 rounded-[24px] bg-black bg-opacity-[0.2] py-2 pl-6 pr-[4.4rem] md:py-4">
                <Link
                  href={`/`}
              ...
              <div className="relative flex flex-col">
                <h1 className="z-[2] pl-[1.5rem] text-[40px] md:text-[72px]">
                  Novi proizvodi
                </h1>
                <p
          ...
          <div className="col-span-1 pr-[20%] pt-[2.2rem] max-md:col-span-2 max-md:mt-[3rem]">
            {singleCategory?.images?.icon ? (
              <div className="relative flex items-start">
                <Image
                  src={singleCategory?.images?.icon}
                  width={560}
                  height={560}
                  alt="HOB"
                  className="relative z-[6] ml-4"
                />
