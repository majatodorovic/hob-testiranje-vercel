...
const Povracaj = () => {
  ...
  return (
    <Provider reCaptchaKey={process.env.CAPTCHAKEY}>
      ...
      <div className="prose mx-auto mt-[1.2rem] w-[95%] md:mt-[9rem] md:w-[60%]">
        <h1 className="pb-7 text-center text-[1.313rem] font-bold text-[#262626]">
          Povraćaj sredstava
        </h1>
        <section
        ...
        <section
          className="elementor-section elementor-top-section elementor-element elementor-element-3902c11 elementor-section-boxed elementor-section-height-default elementor-section-height-default flex flex-col gap-3"
          data-id="3902c11"
          data-element_type="section"
        >
          <div className="elementor-container elementor-column-gap-no">
        ...
        <div className={`mt-10`}>
          ...
          <form
            className={`mt-10 grid gap-x-3 gap-y-5 max-md:grid-cols-1 md:grid-cols-2`}
          ...
          >
            ...
            <div className={`col-span-1 mt-5 text-left md:col-span-2`}>
              <h1 className={`text-lg font-medium`}>Podaci o potrošaču</h1>
            </div>
            <div className={`col-span-1 mt-5 flex flex-col md:col-span-2`}>
            ...
            <div
              className={`col-span-1 flex flex-col items-start md:col-span-2`}
            >
              <label className={`text-base font-light`}>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 w-full border border-[#e0e0e0] focus:border-[#e0e0e0] focus:outline-0 focus:ring-0`}
              />
            </div>
            <div className={`col-span-1 flex flex-col items-start`}>
              <label className={`text-base font-light`}>
            ...
            <div className={`col-span-1 md:col-span-2`}>
              <div className={`flex items-center justify-end`}>
                <button
                  type={`submit`}
                  className={`bg-[#191919] px-10 py-2 text-white hover:bg-opacity-80 max-sm:w-full`}
                  onClick={handleSubmit}
                >
                  {loading ? (
                    <i
                      className={`fa fa-solid fa-spinner fa-spin text-center text-lg text-white`}
                    />
                  ) : (
                    `Pošalji`
                  )}
